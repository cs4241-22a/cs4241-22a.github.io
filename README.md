*[Course Assignments & Due Dates](https://github.com/cs4241-22a/cs4241-22a.github.io/blob/main/cal.md)*
...
Note that our first day of class is *Wednesday, August 24th*, as WPI will be following a Monday schedule that day. Also note that Monday September 5th is a holiday (Labor Day); no class will be held.

Course Staff
---
*Instructor*: Charlie Roberts (@cdroberts)  
*TA*: Noelle Rakotondravony (@ntrakotondravony)  
*GLA*: Jasmine Duerk (@jlduerk)  
*SA*: Kyle McFatter (@kwmcfatter)  
...
Topics include: web scripting and markup languages, design of browser-based interfaces, client/server network architectures, and web accessibility.  
...
Git if you don't have prior experience with it; it will not be taught in the class. The course TAs/SAs can provide help with Git for those who need it; please take advantage of
their expertise!
...
component libraries, or server development. Assignment are due by the start of class on the date listed on the calendar, e.g. 
...
We'll be using node.js for simplicity and language consistency across client / server development. [Deno](deno.land) and [Bun](https://bun.sh/) are node.js alternatives that are worth exploring.
...
But if you've never used vim (or emacs), I recommend using [VSCode](https://code.visualstudio.com), which is free and available for most platforms. In class, I'll VSCode for most demos.
...
In rare cases I may adjust the threshold downward, but *never* up.

Late homework is not accepted without a medical reason or prior permission from the course instructor. Please DM both the course instructor and the primary grader (Jasmine) for small extensions. If it is a personal matter you which to discuss it's of course fine to only contact the instructor. *It is much better to submit partially complete work than nothing at all.* 
Tell us what you have completed and you will get partial credit... even just making an empty pull request for an assignment will get you some points. In fact, my policy is to always give generous partial credit. Even just cloning the assignment repo will get you *something*.
...
If you then completed 6 points of technical achievements and 4 points of design achievements, you would receive an 90% (A) on the assignment. If you completed all 20 acheivement points, you would still get a 100%, even after missing some points on the primary assignment requirements.
...
Students are likewise forbidden from facilitating other students, current or future, in plagiarism or cheating. Collaboration is, however, encouraged in this class. There are many ways in which you can assist your fellow students without giving them code and answers.
Please feel free to answer low-level coding questions and to help your classmates troubleshoot their code.
But do not provide significant chunks of code; for example, providing an entire server that you've written is not allowed. We highly encourage everyone to spend time in the course Discord server, both asking and answering questions about any topics from the course.
